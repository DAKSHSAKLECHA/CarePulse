...
router.post("/upload", authMiddleware, roleMiddleware("patient"), upload.single("file"), uploadPrescription);

// Route to get all prescriptions (Protected)
router.get("/", authMiddleware, roleMiddleware("patient"), getPrescriptions);
