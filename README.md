...
CarePulse is a **telehealth platform** designed to provide seamless healthcare services, including virtual consultations, medicine recommendations, and **secure prescription storage**. The platform ensures **accessibility and convenience** for both patients and healthcare providers.
...
🔗 **Live Project Link:** https://CarePulse.onrender.com/
...
1️⃣ Clone the repository:
   ```bash
   git clone https://github.com/mahak1411/CarePulse.git
   cd CarePulse
   ```
